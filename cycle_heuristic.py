...
def write_output(file_num, solution, list_of_kingdom_names, path_dict):
    file = open("./outputs_heu/" + file_num + ".out", "w")
...
for file_name in file_names:
    ...
    if number_of_kingdoms < 100 or file_name in ["195.in", "207.in", "208.in", "209.in", "336.in", "337.in", "338.in", "528.in", "529.in",\
         "594,in", "596.in", "642.in", "643.in", "644.in"]:
        continue
    print("#########################")
    print(file_name)
    print("#########################")
    ...
    with open("./curr_heu.txt", "w") as file_curr:
    ...
    for dom_cost, dom_set in top10_dom:
        ...
        if curr_best > val:
            with open("./beaten_heu.txt", "a") as file:
                file.write(file_num + "\n")
        ...
        with open("./beaten_heu.txt", "a") as file:
            file.write(file_num + " Not Beaten" "\n")
            file.write("curr_best: " + str(curr_best) + "\n")
            file.write("new_best: "+ str(val) + "\n" + "\n")
